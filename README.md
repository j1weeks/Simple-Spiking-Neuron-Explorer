...
A graphical user interface for graphing excitable neurons using the method described by Eugene Izhikevich in his paper, "Simple Model of Spiking Neurons" (2003).
